...
const VolumeControl = () => {
    ...
    return (
        <div className='flex justify-center gap-x-2 text-white'>
            <button className='opacity-70 hover:opacity-100 transition' onClick={handleVolumeSilence}>
...
const SongControl = ({audio}) => {
    ...
    return (
        <div className="flex gap-x-3 text-xs mb-4">
            ...
            <Slider
                ...
                className='w-[500px]'
            />
            <span className='opacity-50 w-12'>{formatTime(audio?.current?.duration) ?? '00:00'}</span>
        </div>
        ...
        <div className="flex flex-row justify-between w-full px-4 z-50">
            ...
            <div className="grid place-content-center gap-4 flex-1">
                <div className="flex justify-center">
                    <button className={`${currentMusic.song? 'bg-white': 'bg-gray-400'} rounded-full p-2`} onClick={handleClick} disabled={!currentMusic.song}>
